    ...
    <div class="row text-center g-4">
      <div class="col-lg-3 col-sm-6">
        <div class="team-member card-effect">
          <img src="..\images\darshan1.jpeg" alt="">
          <h5 class="mb-0 mt-4">Darshan Panchal</h5>
          <p>Web Designer</p>
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="team-member card-effect">
          <img src="..\images\amba.jpg" alt="">
          <h5 class="mb-0 mt-4">Ambaprasad Pathak</h5>
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="team-member card-effect">
          ...
          <h5 class="mb-0 mt-4">Krish Shukla</h5>
          <p>Documentation Writer</p>
          <div class="social-icons">
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="team-member card-effect">
          ...
          <h5 class="mb-0 mt-4">Jay Parekh</h5>
          <p>Web Developer</p>
          <div class="social-icons">
          </div>
        </div>
